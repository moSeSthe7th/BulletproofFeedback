...
public class TutBlockScript : Rotatable
{
    ...
    {
        if (TutorialManager.Level > 1 && shiftProbability < 70)
        {
            shiftProbability += 7;
        }
    }
    ...
    /* public void Shift(float pos)
     {
         ...
         {
             TutorialManager.instance.SwipeBlockRight(this.gameObject);
             //StartCoroutine(TutorialManager.instance.swipeRight(this.gameObject,false,1f,10f));
         }
         else if (pos == BlockCreater.BlockPos[1])
         {
             ...
             {
                 //StartCoroutine(TutorialManager.instance.swipeLeft(this.gameObject, false,1f, 10f));
                 TutorialManager.instance.SwipeBlockLeft(this.gameObject);
             }
         }
